...
CREATE TABLE `users_credit_cards` (
  ...
  `cvc_check` tinyint(1) DEFAULT NULL,
  `street_check` tinyint(1) DEFAULT NULL,
  `zip_check` tinyint(1) DEFAULT NULL,
  `cc_copy` tinyint(1) DEFAULT NULL,
  `cc_bin` tinyint(1) DEFAULT NULL,
  `id_copy` tinyint(1) DEFAULT NULL,
  `bank_v` tinyint(1) DEFAULT NULL,
  `risk_check` tinyint(1) DEFAULT NULL,
  `ver_attempt` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
