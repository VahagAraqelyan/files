...
$('.date_statistic').on('changeDate', function(ev){
    $(this).datepicker('hide');
});

$('.search_statistic').click(function () {
    var url = base_url+'statistic/search_statistic';
    var data = {'date':$('.date_statistic').val()};
    send_ajax(url, 'post', data, {answer:'.order_statistic_main'});
});