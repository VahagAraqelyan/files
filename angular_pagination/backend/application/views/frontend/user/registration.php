                    ...
                    <div class="register-block">
                        ...
                        <form method="post" class="form-horizontal" id="registration_form">
                            <div class="form-group">
                                <label for="first_name" class="col-sm-3 control-label text-right">First Name</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" maxlength="25"  name="first_name" id="first_name" placeholder="First Name" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="last_name" class="col-sm-3 control-label text-right">Last Name</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label for="retype_password" class="col-sm-3 control-label text-right">Retype Password</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control selectpicker select-country" name="country" id="country">
                            ...
                            <div class="form-group" id="select-state"> </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <p class="change-captcha-picture text-right"> <a id="change-captcha" style="cursor: pointer;width: 100px;height: 40px;">Change Code</a></p>
                                </div>
                            </div>
                            <div class="form-group accep-form-place">
                                <div class="col-sm-offset-3 col-sm-9 text-right terms-conditions">
                                  <div class="checkbox">
                                    <label>
                                      <input type="checkbox" name="accept" id="accept"> I Accept Luggage To Ship <a href="#" id="terms_conditions" class="terms_conditions">Terms & Conditions</a>.
                                    </label>
                                  </div>
                                </div>
                            </div>
                        ...
                        <div class="footer-part">
                            <div class="form-group">
                                <div class="col-sm-12 text-right">
                                    <span class="arleady-member already_member_mobile">Already a member?</span> <a href="<?php echo base_url(); ?>login"> <button type="submit" class="btn btn-default btn-login-orange">Login</button></a>
                                </div>
                            </div>
                        </div>
