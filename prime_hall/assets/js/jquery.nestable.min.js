...
(function($, window, document, undefined) {
    ...
    var defaults = {
        contentCallback: function(item) {return item.content || '' ? item.content : item.name_am;},
        listNodeName: 'ol',
        itemNodeName: 'li',
        handleNodeName: 'div',
        ...
        addIcon: '',
        editIcon: '<span class="fa fa-plus dd_add_menu"></span> <i class="fa fa-fw fa-edit dd-edit"></i>',
        deleteIcon: '<i class="fa fa-trash-o delete dd-delete"></i> ',
        group: 0,
        maxDepth: 5,
        threshold: 20,
        ...
        itemRenderer: function(item_attrs, content, children, options, item) {
            ...
            html += options.deleteIcon;
            html += options.editIcon;
