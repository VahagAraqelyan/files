...
$config['section_url'] = [
    ...
    REPORT_PERM[0]           => ['url' => 'admin/report/report','data_block' => 'report'],
    INCOMPLETE_ORDER_PERM[0] => ['url' => 'admin/order/uncompeted_order','data_block' => 'uncompeted_order'],
    ...
    INCOMPLETE_CLOSED[0]     => ['url' => 'admin/order/incomplete_closed','data_block' => 'incomplete_closed']
];
