<section class="filter">
            ...
            <section class="promo">
                ...
                <div class="slider_content">
                    <div class="slider_content_pos">
                        ...
                        <h2 class="promo__title">Философия совершенного гостеприимства</h2>
                        ...
                        <div class="calendar_main">
                            ...
                            <div class="calendar col-6">
                                <h5>ЗАБРОНИРОВАТЬ МЕРОПРИЯТИЕ</h5>
            ...
            <div class="our_menu_main">
                <div id="our_menu">
                    <div>
                        <div>
                            <h4>Наше меню</h4>
                            <button type="button" class="btn btn-primary show_menu">меню</button>
                        </div>
                    </div>
                    <div class="img_div">
    ...
    if(!empty($offer)){ ?>
        <div class="special_offer special_offer_hidden">
            <div class="title title_theme_sand">СПЕЦИАЛЬНЫЕ ПРЕДЛОЖЕНИЯ</div>
            <div class="specs">
                    ...
                    foreach ($offer as $index => $val){ ?>
                        <div class="columns__col columns__col_3">
                            <div class="specs__item">
                                <a href="<?php echo base_url('ru/home/single_offer/').$val['id']?>" class="preview preview_specs">
                                <span class="preview__img-wrapper">
                                    <img class="preview__img" src="<?php echo base_url('image_upload/offers/').$val['image'];?>" alt="">
                                </span>
                                    <span class="preview__name lazyimgs"><?php echo $val['title_ru']?></span>
                                </a>
                            </div>
                        </div>
                    <?php } ?>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC36B3BK5OaEmBOADTokWJlAfgpNnC6JmU&callback=initMap"
        async defer></script>