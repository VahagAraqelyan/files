            ...
            <div class="content offer_main">
                ...
                <div class="about_us_content">
                    <form action="" method="post" autocomplete="off" id="about_us_form">
                        ...
                        <div class="form-group my-form-group">
                            <div class="col-4 control-label value-index">Предложение:
                            </div>
                            <div class="col-8  value-info">
                        ...
                        <div class="form-group my-form-group">
                            ...
                            <div class="col-4  value-info">
                                <button type="button" id="save_about_us" class="btn btn-primary">Подтвердить</button>
                            </div>
                        </div>
                    </form>
...
<div class="modal login-fast inform-fast" id="succ_modal">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Ваше предложение было успешно отправлено. Спасибо</p>
            </div>
        </div>
    </div>
</div>
