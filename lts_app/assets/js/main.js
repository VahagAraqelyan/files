...
$(window).on('load', function(){
    $('#full_page_loader').fadeOut(500);
    $('#content_main_container').fadeIn(500);
});
        ...
        marker.addListener('click', function() {
            ...
            if(order_shipping_fedex_use_address){
                ...
                infoWindow.setContent('<div><strong>' + name + '</strong><br>' +
                    address + '</div>'+'' + '<div><a href="#" class="btn btn-default btn-file select-doc-file fill_butt fill_butt_fedex" data-index='+index_fedex+'>Use this address as origin address</a></div>'
                );
...
$(document).on('click touchstart', '.chosen-container.chosen-container-single', function () {

   $('.filter-block .form-control').blur()
});
