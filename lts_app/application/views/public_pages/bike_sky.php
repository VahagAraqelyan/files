...
?>
<section class="filter ship-skis-bg">
    <div class="container">
...
<div class="content">
    <div class="container">
        <div class="block-section">
            <h1 class="cont-title">Ship Skis & Snowboard</h1>
            <h6 class="cont-description">Hug the snow mountain, and enjoy the vacation without hassle</h6>

            <h3>Why Ship Your Skis or Snowboard</h3>
            <div class="row">
                <div class="col-md-12">
                    <div class="sl-info sl-long">
                        ...
                        <div class="sl-content">
                            ...
                            <p>Avoid the hassles of carrying big Ski or Snowboard all the trip</p>
                        </div>
                    </div>
                    <div class="sl-info sl-long">
                        ...
                        <div class="sl-content">
                            ...
                            <p>No additional cost to move your skis, snowboard and luggage between airport, resort and home.</p>
                        </div>
                    </div>
                    <div class="sl-info sl-long">
                        ...
                        <div class="sl-content">
                            ...
                            <p>Enjoy a lighter trip without heavy and big skis or snowboard.</p>
                            <p>Skis, snowboard and luggage are waiting for you at resort or your home.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="block-section">
            <div class="row">
                <div class="col-md-12">
                    <h3>Our Skis and Snowboard Shipping Services</h3>
                    <div class="sl-info">
                        <ul class="short-line-height">
                            ...
                            <li>We arrange pick-ups at scheduled time frames from your door, and deliver skis or snowboard to your resort, hotel or home at destination. </li>
                            <li>You may drop off your skis or snowboard at over 250,000 locations worldwide</li>
                            ...
                            <li>We provide up-to 6 months of free storage services for your skis or snowboard.</li>
                        </ul>
                    </div>
        ...
        <div class="block-section">
            <h3>How to Pack and Label Your Skies or Snowboard</h3>
            <div class="row">
                <div class="col-md-6">
                    <div class="sl-info sl-short sl-small">
                        <span><i class="icon-packing-skes-second"></i></span>
                        <div class="sl-content">
                            <h6>Packing</h6>
                        </div>
                    </div>
                    <div class="sl-info">
                        <ul class="short-line-height">
                            <li>Wrap  the ski or snowboard with bubble wrapping to avoid scratching </li>
                            <li>Use a soft or hard ski/snowboard travel case or bag</li>
                            <li>Secure the bag with bag buckles and straps </li>
                            <li>Close or zip up all pockets</li>
                            <li>US Domestic shipment: please lock your bag by TSA approved locks or cable ties.</li>
                            <li>International shipment: please ONLY use Cable Ties to lock your bag.</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="sl-info">
                        <ul class="short-line-height">
                            ...
                            <li>Stick the pouch tightly to a luggage tag, and secure the tag to the top handle of your ski or snowboard bag</li>
                            <li>Put an additional copy of label and document inside your bag. </li>
        ...
        <div class="block-section items-block-part bike_sky">
            <div class="row">
                <div class="col-md-3">
                    <div class="luggage-img">
                        <img id="img_5" src="<?php echo base_url(); ?>assets/images/small_snowboard.png">
                    </div>
                    <div class="luggage-content">
                        <p class="blue-color item-title">Ski Bag</p>
                        <p>Max Weight: <span class="orange-color">22lbs / 10kg</span></p>
                        <p>Max Length: <span class="orange-color">72inch / 183cm</span></p>
                        <p>Max Girth: <span class="orange-color">25inch / 64cm</span></p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="luggage-img">
                        <img id="img_5" src="<?php echo base_url(); ?>assets/images/double_sky_bag.png">
                    </div>
                    <div class="luggage-content">
                        <p class="blue-color item-title">Double Ski Bag</p>
                        <p>Max Weight: <span class="orange-color">40lbs / 18kg</span></p>
                        <p>Max Length: <span class="orange-color">74inch / 188cm</span></p>
                        <p>Max Girth: <span class="orange-color">36inch / 92cm</span></p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="luggage-img">
                        <img id="img_5" src="<?php echo base_url(); ?>assets/images/large_snowboard.png">
                    </div>
                    <div class="luggage-content">
                        <p class="blue-color item-title">Small Snowboard</p>
                        <p>Max Weight: <span class="orange-color">30lbs / 14kg</span></p>
                        <p>Max Length: <span class="orange-color">65inch / 165cm</span></p>
                        <p>Max Girth: <span class="orange-color">36inch / 92cm</span></p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="luggage-img">
                        <img id="img_5" src="<?php echo base_url(); ?>assets/images/bike_box.png">
                    </div>
                    <div class="luggage-content">
                        <p class="blue-color item-title">Large Snowboard</p>
                        <p>Max Weight: <span class="orange-color">40lbs / 18kg</span></p>
                        <p>Max Length: <span class="orange-color">75inch / 190cm</span></p>
                        <p>Max Girth: <span class="orange-color">48inch / 122cm</span></p>
                    </div>
                </div>
            </div>
        </div>
