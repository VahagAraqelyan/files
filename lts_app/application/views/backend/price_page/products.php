                ...
                <table class="table table-bordered designed-table">
                    ...
                    <tr>
                        ...
                        foreach ($curriers as $currier){ ?>
                            ...
                            <th><small><?php echo  $currier['currier_name']; ?></small></th>
               ...
               if(!empty($type['prod'])){
                  ...
                  foreach ($type['prod'] as  $key => $single ){  ?>
                    <tr>
                        ...
                        <td><input type="text" value="<?php echo (!empty($single['api_size']))?$single['api_size']:''; ?>" name="max_size_<?php echo $key; ?>" class="form-control big-input "></td>
                        ...
                        <td><input type="text" value="<?php echo (!empty($single['size']))?$single['size']:''; ?>" name="size_<?php echo $key; ?>" class="form-control big-input "></td>
                        ...
                        <td ><span class="plus-sign orange-color"><i class="fa fa-plus"></i></span></td>
                          ...
                          foreach ($curriers as $currier_id => $currier){
                              ...
                              ?>
                              <td><input type="text" value="<?php echo $value;  ?>" name="currier_<?php echo $key.'['.$currier_id.']'; ?>" class="form-control not_string"></td>
                          <?php } ?>
                    </tr>
                    <?php  }  } ?>
                    </tbody>
