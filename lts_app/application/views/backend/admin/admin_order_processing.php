                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default designed-panel panel-bordered light">
                                ...
                                <?php
                                $real_service = $order['currier_name']." ".str_ireplace(['outbound ', 'inbound'], '', $order['original_send_type']);
...
;
                                                        ...
                                                        <select class="form-control selectpicker document_name" name="" id="type_id">
                                                            ...
                                                            if(!empty($order_file_types)){
                                                                foreach ($order_file_types as $index => $value){
                                                                    ...
                                                                    if(stripos($order['currier_name'],'dhl')  === FALSE && $value['value'] == 'Archive_review'){

                                                                        continue;
                                                                    }

                                                                    if(stripos($order['currier_name'],'fedex')  === FALSE && $value['value'] == 'fedex_second_label'){
                                    ...
                                    <?php } ?>
                                        ...
                                        <div class="col-md-2 create-label-div">
                                            <button type="button" class="btn btn-default btn-login-orange adm-btn create-label" id="create_label">Create Label</button>
                                        </div>
                                        <?php
