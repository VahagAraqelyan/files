...
class Check_price_model extends CI_Model
{
    ...
    public function get_international_fee($country_id, $currier_id, $luggages){
        ...
        $this->db->select('luggage_id, international_fee');
        ...
        foreach($result as $single){
            $return_data[$single['luggage_id']] = $single['international_fee'];
        }
    ...
    public function get_boxes_international($country_id){
        ...
        $this->db->select('luggage_name, currier_id, international_fee');
        $this->db->from('luggage_product');
        ...
        foreach($result as $single){
            ...
            if(empty($return_array[strtolower($single['luggage_name'])])){
                ...
                $return_array[strtolower($single['luggage_name'])] = [
                    $single['currier_id'] => $single['international_fee']
                ];

            }else {
                $return_array[strtolower($single['luggage_name'])][$single['currier_id']] = $single['international_fee'];
            }
